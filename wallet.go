...
type Wallet struct {
	...
	Balance        int64  `json:"balance"`         // The current balance of the wallet.
	...
	PendingBalance int64  `json:"pending_balance"` // The pending balance of the wallet.
	...
	TotalReceived  int64  `json:"total_received"`  // The total amount received in the wallet.
